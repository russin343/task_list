...
function getTasks() {
  ...
  // loop thru the tasks that are there
...
function storeTaskInLocalStorage(task) {
  let tasks;
  // if = null, there's nothing in there
  // so set tasks to empty array
  if(localStorage.getItem('tasks') === null){
    tasks = [];
  } else {
    // set tasks = whatevers in localstorage
    tasks = JSON.parse(localStorage.getItem('tasks'));
  }

  // then push on the tasks that were passed in as parameter
  tasks.push(task);
